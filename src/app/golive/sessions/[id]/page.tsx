...
export default function LiveSessionSummaryPage() {
  ...
  useEffect(() => {
    fetch(`/api/live/session/${params.id}`)
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-[1100px] px-6 py-6">
        {detail === null ? (
          ...
          <div className="glass-panel rounded-2xl p-10 text-center text-ld-red">This Live Session could not be found.</div>
        ) : (
          <>
            ...
            <p className="mb-6 text-sm text-ld-muted">
              ...
              {detail.session.status === "active" && " · still live"}
            </p>
            ...
            <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-7">
              ...
              <StatCard label="Revenue" value={formatCurrency(detail.stats.revenue)} accent="text-ld-green" />
              <StatCard
                label="Est. Profit"
            ...
            {detail.items.length === 0 ? (
              <p className="rounded-xl border border-dashed border-ld-border p-6 text-center text-sm text-ld-muted">
                Nothing was presented in this session.
              </p>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.presentation.outcome === "sold" ? (
                        <p className={`shrink-0 text-sm font-bold ${canceled ? "text-ld-red line-through" : "text-ld-green"}`}>
